...
setup(
    name='sopel_modules.post_doc',
    version='0.1.0',
    description='Sopel Cookiecutter contains a template for a PyPI-distributable Sopel module',
    long_description=readme + '\n\n' + history,
    author='Sydney Henry',
    author_email='shenry@handycodejob.com',
    url='http://github.com/sydhenry/sopel-post-doc',
